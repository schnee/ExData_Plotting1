...
households$Voltage = as.numeric(households$Voltage)
households$Global_reactive_power = as.numeric(households$Global_reactive_power)
...
plot(households_slice$timestamp, 
     households_slice$Global_active_power, type="l", ylab="Global Active Power", xlab="")

# 1,2
plot(households_slice$timestamp,
     households_slice$Voltage, type="l", xlab="datetime", ylab="Voltage")
# 2,1
plot(households_slice$timestamp, 
...
# 2,2
plot(households_slice$timestamp,
     households_slice$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
